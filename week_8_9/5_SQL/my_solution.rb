...
# How does the sqlite3 gem work?  What is the variable `$db` holding?  
 #by using sqlite3, you can work with database on ruby. 
...
# your fellow students.  
 #That code will return the names of the congress members who were in congress longer than minimum years. 
